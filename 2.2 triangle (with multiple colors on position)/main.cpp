...
"void main()\n"
"{\n"
"color = vec4(pos.x, pos.y, pos.z, 0.7f);\n"
"}";
...
int main()
{
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Learn OpenGL", nullptr, nullptr); // the third arg can be set to make full screen
